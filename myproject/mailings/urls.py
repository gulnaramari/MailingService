...
urlpatterns = [
    ...
    path(
        "messages/<int:pk>/delete/", MessageDeleteView.as_view(), name="delete_message"
    ),
    ...
    path(
        "mailings/<int:pk>/delete/", MailingDeleteView.as_view(), name="delete_mailing"
    ),
    path("mailings/<int:pk>/send/", MailingsService.send_mailing, name="send_mailing"),
